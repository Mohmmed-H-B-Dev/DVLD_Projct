   ...
   public class clsLocalDrivingLicenseApplication : clsApplication
    {
       ...
       public enum enMode { AddNew=1,Update=2 };
...

        {
            ...
            base.CreatedByUserInfo=clsUser.FindUserByUserID(CreatedByUserID);
        ...
        {
            int LDLA_ID = -1;int LicenseClassID = -1;

            bool IsFound = clsLocalDrivingLicenseApplicationData.GetLocalDrivingLicenseApplicationInfoByApplicationID(ApplicationID, ref LDLA_ID, ref LicenseClassID);
            if (IsFound)
            {
                ...
                //we return new object of that person with the right data
                return new clsLocalDrivingLicenseApplication(
                    LDLA_ID, Application.ApplicationID,
                    Application.ApplicantPersonID,
                                     Application.ApplicationDate, Application.ApplicationTypeID,
                                    (enApplicationStatus)Application.ApplicationStatus, Application.LastStatusDate,
                                     Application.PaidFees, Application.CreatedByUserID, LicenseClassID);

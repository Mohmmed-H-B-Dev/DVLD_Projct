...
namespace DVLD_Buisness
{
    public class clsLicense
    {
        ...
        public bool ReleaseDetainedLicense(int ReleasedByUserID,ref int ApplicationID)
        {
            ...
            Application.PaidFees = clsApplicationType.GetApplicationTypeInfoByID((int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicsense).Fees;
        ...
        public clsLicense RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationType.GetApplicationTypeInfoByID((int)clsApplication.enApplicationType.RenewDrivingLicense).Fees;
            ...
            //Create New License and Store the last Data And the Current Data 
        ...
        public clsLicense Replace(enIssueReason IssueReason, int CreatedByUserID)
        {
            ...
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationType.GetApplicationTypeInfoByID(Application.ApplicationTypeID).Fees;
            Application.CreatedByUserID = CreatedByUserID;
